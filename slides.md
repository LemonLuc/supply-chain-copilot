...
<section class="slide-section problem-slide">
  ...
  <div class="signal-flow">
    <div><span class="icon-chip i-lucide-database"></span><b>SAP</b><ul><li>POs</li><li>Material master</li><li>MRP exceptions</li></ul></div>
    <div><span class="icon-chip i-lucide-warehouse"></span><b>Warehouse</b><ul><li>EWM stock</li><li>Goods receipts</li><li>Production buffers</li></ul></div>
    <div><span class="icon-chip i-lucide-truck"></span><b>Carriers</b><ul><li>DHL / FedEx</li><li>ETA changes</li><li>Customs events</li></ul></div>
    <div><span class="icon-chip i-lucide-factory"></span><b>Suppliers</b><ul><li>Commit dates</li><li>Capacity</li><li>Quality status</li></ul></div>
    <div><span class="icon-chip i-lucide-file-spreadsheet"></span><b>Files</b><ul><li>Scorecards</li><li>Excel trackers</li><li>Contracts</li></ul></div>
  </div>
...
<section class="slide-section">
  ...
  <div class="surface-pair">
    <div><span class="icon-chip i-lucide-messages-square"></span><h2>ChatGPT</h2><ul><li>Executive and team-facing front end</li><li>Ask questions, inspect evidence, coordinate next steps</li><li>Natural adoption path for planners and leaders</li></ul></div>
    <div><span class="icon-chip i-lucide-cpu"></span><h2>OpenAI API + SDK</h2><ul><li>Backend integration layer for the Supply Chain Hub</li><li>Streaming answers, tool orchestration, evals and guardrails</li><li>Connects OpenAI into ZEISS workflows without replacing systems of record</li></ul></div>
  </div>
...
<section class="slide-section solution-slide">
  ...
  <div class="solution-grid">
    <div><span class="icon-chip i-lucide-message-circle"></span><h2>Decision surface</h2><p>ChatGPT-style experience for planners, procurement leaders and executives.</p></div>
    <div><span class="icon-chip i-lucide-route"></span><h2>Decision intelligence</h2><p>Responses API, AI SDK streaming, reasoning summaries, tools and evaluations.</p></div>
    <div><span class="icon-chip i-lucide-shield-check"></span><h2>Control plane</h2><p>Role scope, source filtering, financial masking, approvals and audit logs.</p></div>
  </div>
  <div class="consequence-band">
    <span>Consequence</span>
    <p>Decisions move from late escalation to governed action, while ZEISS keeps control over data, policy and execution.</p>
  </div>
...
<section class="slide-section workflow-slide">
  ...
  <div class="workflow-proof">
    <div><span class="icon-chip i-lucide-search-check"></span><h2>What executives see live</h2><p>A risk question becomes a grounded answer, a traceable recommendation and an approval-ready next step.</p></div>
    <div><span class="icon-chip i-lucide-sparkles"></span><h2>Why it creates curiosity</h2><p>The demo shows the same pattern across risk, supplier alternatives and resilience trade-offs without changing the underlying systems.</p></div>
  </div>
...
<section class="slide-section demo-intro">
  <p class="eyebrow">Demonstration</p>
  <h1>The demo is the business case</h1>
  <p class="hero-line">Three workflows show the same OpenAI platform pattern at increasing decision altitude.</p>
  <div class="demo-menu">
    <div><span>01</span><h2>Risk Radar</h2><p>Find material delivery risk before the escalation meeting.</p></div>
    <div><span>02</span><h2>Supplier alternatives</h2><p>Identify approved coverage when a critical supplier slips.</p></div>
    <div><span>03</span><h2>Cost vs. resilience</h2><p>Balance consolidation savings against continuity risk.</p></div>
  </div>
...
<section class="demo-slide">
  <p class="eyebrow">Demo workflow 1</p>
  <h1>Risk Radar</h1>
  <div class="demo-card">
    <p class="demo-question">“Is N-FK5 delivery at risk this week?”</p>
    <ul><li>DHL exception moved ETA to Thursday, 25 June</li><li>FedEx backup protects only 2.5 production days</li><li>Action path: draft carrier follow-up and notify logistics lead</li></ul>
  </div>
...
<section class="demo-slide">
  <p class="eyebrow">Demo workflow 2</p>
  <h1>Supplier alternatives</h1>
  <div class="demo-card">
    <p class="demo-question">“Which approved alternatives can cover the turret delay?”</p>
    <ul><li>14 Axioscan 7 builds affected</li><li>Mechatronik Sued can cover eight units in six days</li><li>Six-build gap remains for resequencing</li></ul>
  </div>
...
<section class="demo-slide">
  <p class="eyebrow">Demo workflow 3</p>
  <h1>Cost vs. resilience</h1>
  <div class="demo-card">
    <p class="demo-question">“Where can we consolidate without weakening continuity?”</p>
    <ul><li>Consolidate standard packaging and brackets</li><li>Protect optical glass redundancy</li><li>Route high-impact supplier changes to approval</li></ul>
  </div>
...
<section class="slide-section scorecard-slide">
  ...
  <h1>Scale only when the pilot proves value, trust and control</h1>
  <div class="scorecard-grid">
    <div><span class="icon-chip i-lucide-timer"></span><h2>Decision speed</h2><b>25%</b><p>Faster weekly risk-review cycle versus baseline.</p></div>
    <div><span class="icon-chip i-lucide-badge-check"></span><h2>Grounding quality</h2><b>90%</b><p>Answers cite approved ZEISS sources and show assumptions.</p></div>
    <div><span class="icon-chip i-lucide-users"></span><h2>User pull</h2><b>80%</b><p>Target users rate outputs useful for real workflows.</p></div>
    <div><span class="icon-chip i-lucide-shield"></span><h2>Governance</h2><b>100%</b><p>High-impact actions route to human approval.</p></div>
    <div><span class="icon-chip i-lucide-euro"></span><h2>Business signal</h2><b>Tracked</b><p>Expedite exposure, triage hours and avoided escalations.</p></div>
    <div><span class="icon-chip i-lucide-activity"></span><h2>Operational readiness</h2><b>Ready</b><p>Eval set, audit logging, support owner and rollout path.</p></div>
  </div>
  <p class="scorecard-thesis">SE strategy: prove a reusable governed-decision pattern, then expand to adjacent ZEISS functions with measured trust and business impact.</p>
...
<section class="slide-section closing-slide">
  ...
  <div class="closing-path">
    <div><span class="icon-chip i-lucide-package-check"></span><h2>Supply Chain Hub</h2><p>Prove risk visibility, supplier alternatives and resilience decisions.</p></div>
    <div class="closing-arrow">→</div>
    <div><span class="icon-chip i-lucide-line-chart"></span><h2>Finance Hub</h2><p>Extend to working capital, expedite exposure and scenario planning.</p></div>
    <div class="closing-arrow">→</div>
    <div><span class="icon-chip i-lucide-microscope"></span><h2>Quality Hub</h2><p>Bring the same governed pattern to deviations, CAPA and supplier quality.</p></div>
  </div>
